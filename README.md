...
<!-- Skill icons provided by skill-icons. Full icon list and names:
     https://github.com/tandpfun/skill-icons?tab=readme-ov-file#icons-list -->
[![My Skills](https://skillicons.dev/icons?i=java,python,js,cs,html,cpp,react,unity,unreal,spring,kotlin,androidstudio,swift,nginx,next,firebase,aws,docker,figma,blender,photoshop,pr,aftereffects,xd,figma,nodejs,git,github&theme=light)](https://skillicons.dev)
